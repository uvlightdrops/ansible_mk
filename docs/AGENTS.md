...
- **NodePorts for SSH**: 30222 (wls-admin), 30223 (wls-managed-1), 30224 (wls-managed-2)
...
- **`k8s/ubuntu-wls-deployments.yaml` is deprecated** – use the split manifests:  
  `deploy-wls-admin.yaml`, `deploy-wls-managed-1.yaml`, `deploy-wls-managed-2.yaml`, `deploy-test-db.yaml`, `services-clusterip.yaml`, `services-nodeports.yaml`
